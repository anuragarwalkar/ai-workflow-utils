...
class StreamingProcessor {
   ...
   */
  static sendStatus(res, message, provider) {
    const statusData = {
      type: 'status',
      message,
      provider,
   ...
   */
  static sendComplete(res, fullResponse, provider) {
    const completeData = {
      type: 'complete',
   ...
   */
  static sendError(res, error, context) {
    const errorData = {
      type: 'error',
      error,
      context,
   ...
   */
  static sanitizeStreamData(data) {
   ...
   */
  static isStreamComplete(data, provider) {
