...
export const EMAIL_CONSTANTS = {
  ...
  STYLES: {
    GROUP_HEADER:
      'background-color:#eef3f7;padding:10px;font-weight:bold;text-align:left;border-left:4px solid #801C81;margin-top:30px;font-family:Arial,sans-serif;font-size:14px;',
    TABLE:
