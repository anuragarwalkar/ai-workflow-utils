...
const LogsViewer = () => {
  ...
  const getLogIcon = (level) => {
    switch (level?.toLowerCase()) {
      ...
      case 'warn': return <WarningIcon sx={{ color: 'warning.main', fontSize: 16 }} />
      case 'info': return <InfoIcon sx={{ color: 'info.main', fontSize: 16 }} />
      case 'debug': return <DebugIcon sx={{ color: 'text.secondary', fontSize: 16 }} />
      default: return <InfoIcon sx={{ color: 'text.secondary', fontSize: 16 }} />
    }
  }
                    ...
                    <TableCell>
                      <Typography 
                        ...
                        sx={{ 
                          ...
                          fontFamily: log.level?.toLowerCase() === 'error' ? 'monospace' : 'inherit',
                          maxWidth: 600,
                          overflow: 'hidden',
