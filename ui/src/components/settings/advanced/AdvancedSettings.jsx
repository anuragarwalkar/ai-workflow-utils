...
const AdvancedSettings = () => {
  ...
  const handleResetAll = () => {
    if (window.confirm('Are you sure you want to reset ALL settings and data? This action cannot be undone.')) {
  ...
  return (
    <Box>
      ...
      <Alert severity="warning" sx={{ mb: 3 }}>
        These settings are for advanced users. Changing these settings may affect application performance or data integrity.
      </Alert>
