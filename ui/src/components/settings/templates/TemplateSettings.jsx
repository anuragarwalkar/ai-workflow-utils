...
const TemplateSettings = () => {
  ...
  const handleReset = async () => {
    if (window.confirm('Are you sure you want to reset all templates to defaults? This will keep your custom templates but restore default settings.')) {
      try {
