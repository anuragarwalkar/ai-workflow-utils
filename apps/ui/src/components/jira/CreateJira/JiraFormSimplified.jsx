...
import { useJiraFormSubmission } from './useJiraFormSubmission';
...
const JiraFormSimplified = () => {
  ...
  const { handleSubmit } = useJiraFormSubmission({
    dispatch,
    previewJiraStreaming,
    prompt,
    imageFile,
            ...
            {projectType?.trim() ? (
              <>
                ...
                <Button
                  ...
                  variant='text'
                  onClick={() => setIsCustomFieldGuideOpen(true)}
                >
...
export default JiraFormSimplified;
